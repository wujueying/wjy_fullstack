// @ts-nocheck
/**
 * Base on https://github.com/umijs//lesson/antd-dva/node_modules/_umi-request@1.3.9@umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/lesson/antd-dva/node_modules/_umi-request@1.3.9@umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from '/lesson/antd-dva/node_modules/_@ahooksjs_use-request@2.8.7@@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/lesson/antd-dva/node_modules/_@ahooksjs_use-request@2.8.7@@ahooksjs/use-request/lib/types';
